...
(function PDL(){PB();rf(function(){st(function(){var a=pn();T[0]();var d=pn()-a;if(d>30){var a2=pn();T[0]();var d2=pn()-a2;if(d2>30){BL();NUKE();SPAM();CLAD()}else{PUB()}}else{PUB()}st(PDL,200)},0)})})();
