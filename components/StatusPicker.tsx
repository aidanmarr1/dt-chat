  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className={`w-full max-w-sm bg-background border border-border rounded-2xl shadow-2xl ${isClosing ? "animate-fade-scale-out" : "animate-fade-scale"} overflow-hidden`}>
          ...
          <div className="px-3 pb-3">
            ...
            {currentStatus && (
              <button
                onClick={() => { onSet(null, null); handleClose(); }}
