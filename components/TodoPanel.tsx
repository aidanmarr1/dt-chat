        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full gap-4 text-muted px-6">
              ...
              <p className="text-sm font-medium text-foreground animate-fade-in stagger-1">No tasks yet</p>
              <p className="text-xs text-muted/60 text-center animate-fade-in stagger-2">Add a shared task above — everyone in the chat will see it</p>
            </div>
          ) : (
            <div>
              {/* Uncompleted */}
