    ...
    <div className="px-4 py-1 animate-fade-in">
      <div className="flex items-end gap-2">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-1 px-4 py-2.5 rounded-xl bg-surface border border-border rounded-bl-sm">
            <div className="flex gap-[4px]">
              {[0, 1, 2].map((i) => (
                <span
                  key={i}
                  className="w-[6px] h-[6px] bg-muted/60 rounded-full inline-block"
                  style={{
